...
class CookiePage extends StatelessWidget {
                  ...
                  child: GridView.count(
                    ...
                    children: <Widget>[
                      for (var anounce in products)
                        _buildCard(anounce.category, anounce.title,
                            anounce.description, false, false, context),
                    ],
                  )),
              SizedBox(height: 15.0)
            ]);
  ...
  Widget _buildCard(String category, String title, String description,
    ...
    return Padding(
        padding: EdgeInsets.only(top: 18.0, bottom: 9.0, left: 5.0, right: 5.0),
        child: InkWell(
            onTap: () {
                            ...
                            children: [
                              ...
                              Container(
                                ...
                                child: Icon(Icons.question_answer,
                                    color: Color(0xff09bdb4), size: 20.0),
                              ),
                              GestureDetector(
                                onTap: () {
